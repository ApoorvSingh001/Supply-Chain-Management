...
contract('SupplyChain', function(accounts) {
    ...
    it("Testing smart contract function produceItem() that allows a Producer to produce a Product", async() => {
        ...
        await supplyChain.produceItemByProducer(upc, bestBefore, productType, originProducerName, originProducerInformation, originFarmLatitude, originFarmLongitude, productNotes, productPrice, {from:originProducerID})
        ...
        assert.equal(resultBufferTwo[7], bestBefore, 'Error: Invalid Expiry Date')
        assert.equal(resultBufferTwo[8], productType, 'Error: Invalid Product Type')
    ...
    it("Testing smart contract function receivedItemByDistributor() that allows a distributor to receive a Product", async() => {
        ...
        assert.equal(resultBufferOne[2], distributorID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferTwo[6], itemState, 'Error: Invalid item State')
        assert.equal(resultBufferTwo[9], distributorID, 'Error: Invalid distributorID ')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    })
    ...
    it("Testing smart contract function packageItemByDistributor() that allows a distributor to package a Product", async() => {
        ...
        assert.equal(resultBufferOne[2], distributorID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferTwo[6], itemState, 'Error: Invalid item State')
        assert.equal(resultBufferTwo[9], distributorID, 'Error: Invalid retailerID ')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function purchaseItemByRetailer() that allows a retailer to purchase a Product", async() => {
        ...
        assert.equal(resultBufferTwo[6], itemState, 'Error: Invalid item State')
        assert.equal(resultBufferTwo[10], retailerID, 'Error: Invalid retailerID ')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function receivedItemByRetailer() that allows a retailer to receive a Product", async() => {
        ...
        assert.equal(resultBufferOne[2], retailerID, 'Error: Missing or Invalid ownerID')
        assert.equal(resultBufferTwo[6], itemState, 'Error: Invalid item State')
        assert.equal(resultBufferTwo[10], retailerID, 'Error: Invalid distributorID ')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function purchaseItemByConsumer() that allows a consumer to purchase a Product", async() => {
        ...
        assert.equal(resultBufferTwo[6], itemState, 'Error: Invalid item State')
        assert.equal(resultBufferTwo[11], consumerID, 'Error: Invalid distributorID ')
        assert.equal(eventEmitted, true, 'Invalid event emitted')
    ...
    it("Testing smart contract function fetchItemBufferTwo()", async() => {
        ...
        assert.equal(resultBufferTwo[9],distributorID, "Error: Invalid distributorID")
        assert.equal(resultBufferTwo[10],retailerID, "Error: Invalid retailerID")
        assert.equal(resultBufferTwo[11],consumerID, "Error : Invalid consumerID")
